...
##Query
The index is defined under the core "core0" see the configuration file [**solr.xml**](/SolrLiterature/MFNLiteratureApp/solr/solr.xml) in [**/SolrLiterature/MFNLiteratureApp/solr/**](/SolrLiterature/MFNLiteratureApp/solr/). To query the instance use the standard Solr query syntax. You can post the query from the command line using [cURL](http://curl.haxx.se/docs/manpage.html) or by directly typing in your browser. 
